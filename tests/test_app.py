...
def test_chat_completion_plain_text_no_body():
    ...
    assert re.match(
        r'analytics,core_parent_span_id=undefined,core_span_id=undefined,deployment=gpt-4,execution_path=undefined,language=undefined,model=gpt-4,parent_deployment=undefined,project_id=PROJECT-KEY,response_id=(.+?),title=undefined,topic=undefined,trace_id=undefined,upstream=undefined cached_prompt_tokens=20i,chat_id="chat-1",completion_tokens=189i,deployment_price=0.001,number_request_messages=0i,price=0.001,prompt_tokens=22i,user_hash="undefined" 1692214959997000000',
        write_api_mock.points[0],
    )
    assert re.match(
        r'analytics,core_parent_span_id=undefined,core_span_id=undefined,deployment=gpt-4,execution_path=undefined,language=undefined,model=gpt-4,parent_deployment=undefined,project_id=PROJECT-KEY-2,response_id=(.+?),title=undefined,topic=undefined,trace_id=undefined,upstream=undefined cached_prompt_tokens=0i,chat_id="chat-2",completion_tokens=189i,deployment_price=0.001,number_request_messages=0i,price=0.001,prompt_tokens=22i,user_hash="undefined" 1700796820390000000',
